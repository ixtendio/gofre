	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				httpMethod: "GET",
				path:       "/test",
				h: func(ctx context.Context, mc path.MatchingContext) (response.HttpResponse, error) {
...
func TestMuxHandler_HandleXXX(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "GET",
			argsSupplierFunc: func(m *MuxHandler) args {
				m.HandleGet("/get", func(ctx context.Context, mc path.MatchingContext) (response.HttpResponse, error) {
		...
		},
		{
			name: "POST",
			argsSupplierFunc: func(m *MuxHandler) args {
				m.HandlePost("/post", func(ctx context.Context, mc path.MatchingContext) (response.HttpResponse, error) {
		...
		},
		{
			name: "PUT",
			argsSupplierFunc: func(m *MuxHandler) args {
				m.HandlePut("/put", func(ctx context.Context, mc path.MatchingContext) (response.HttpResponse, error) {
			...
			name: "PATCH",
			argsSupplierFunc: func(m *MuxHandler) args {
				m.HandlePatch("/patch", func(ctx context.Context, mc path.MatchingContext) (response.HttpResponse, error) {
			...
			name: "DELETE",
			argsSupplierFunc: func(m *MuxHandler) args {
				m.HandleDelete("/delete", func(ctx context.Context, mc path.MatchingContext) (response.HttpResponse, error) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for _, ep := range endpoints {
				...
				req, _ := http.NewRequestWithContext(ctx, http.MethodGet, "https://www.domain.com"+ep, nil)
